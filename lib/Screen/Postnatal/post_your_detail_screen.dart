...
class PostYourDetailsScreen extends StatefulWidget {
  const PostYourDetailsScreen({super.key,required this.userId
 });
  // final SharedPreferences prefs;
  final int userId;

  @override
  State<PostYourDetailsScreen> createState() => _PostYourDetailsScreenState();
}

class _PostYourDetailsScreenState extends State<PostYourDetailsScreen> {
  String dateis = "";
    LatLng? latlng;
...
http.StreamedResponse response  = await request.send();
    ...
    //     context, "Requesting...", "Please Wait requesting to Add Details...", true);
              ...
              children: [
                  ...
                  child: Image.asset("assets/images/img4.png",height: 60.h,width: 120.w,),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text("Let’s Get Started!",style: mainHeadingStyle,),
                height4,
                ...
                TextFormField(
                  style: textFieldInputStyle,
                              ...
                              contentPadding: EdgeInsets.only(left: 10),
                                  hintText:
                                      "Mark Current Location from Map",
                ...
                Padding(
                  ...
                  child: CustomTheemButton(buttonText: "Let’s Go!", ontap: (){
