...
class PostUpdateDetailsScreen extends StatefulWidget {
  const PostUpdateDetailsScreen({super.key,required this.userId
 });
  // final SharedPreferences prefs;
  final int userId;

  @override
  State<PostUpdateDetailsScreen> createState() => _PostUpdateDetailsScreenState();
}

class _PostUpdateDetailsScreenState extends State<PostUpdateDetailsScreen> {
  String dateis = "";
