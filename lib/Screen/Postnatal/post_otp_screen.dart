...
import 'package:fitmom/Screen/Postnatal/post_purchased_package_screeen.dart';
...
class PostOTPScreen extends StatefulWidget {
  const PostOTPScreen({super.key,required this.mob});
  final String mob;

  @override
  State<PostOTPScreen> createState() => _PostOTPScreenState();
}

class _PostOTPScreenState extends State<PostOTPScreen> {
    ...
    if (sessionData.isNotEmpty) {
      ...
      if (sessionData["message"]
          ...
          .contains("successfully")) {
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context)=>PostPurchasedPacakageScreen(userId: userId,)));
