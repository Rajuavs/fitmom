...
class PosSessionVideoScreen extends StatefulWidget {
  const PosSessionVideoScreen({super.key,required this.userId});
  final int userId;

  @override
  State<PosSessionVideoScreen> createState() => _PosSessionVideoScreenState();
}

class _PosSessionVideoScreenState extends State<PosSessionVideoScreen> {
...
Future<void> _sessionVideoList() async {
    var  apiUrl =
        "https://fitmomwebapi.jaspertech.xyz/api/Users/GetPostnatalUsersSessionVideos";
