...
import 'package:fitmom/Screen/Prenatal/payment/razor_pay.dart';
...
class PurchasedPacakageScreen extends StatefulWidget {
  const PurchasedPacakageScreen({super.key, required this.userId});
  // final SharedPreferences prefs;
  final int userId;

  @override
  State<PurchasedPacakageScreen> createState() => _PurchasedPacakageScreenState();
}

class _PurchasedPacakageScreenState extends State<PurchasedPacakageScreen> {
